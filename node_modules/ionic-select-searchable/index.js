...
import { Component, ContentChild, Directive, EventEmitter, HostBinding, HostListener, Input, IterableDiffers, NgModule, Optional, Output, TemplateRef, ViewChild, forwardRef } from '@angular/core';
...
var SelectSearchablePageComponent = (function () {
    ...
    function (item) {
        ...
        return this.selectComponent.disabledItems.some(function (_item) {
            return _this.selectComponent._getItemValue(_item) === _this.selectComponent._getItemValue(item);
        });
    };
    /**
     * @param {?} item
    ...
    function (item) {
        ...
        return this.selectedItems.find(function (selectedItem) {
            return _this.selectComponent._getItemValue(item) ===
                _this.selectComponent._getStoredItemValue(selectedItem);
        }) !== undefined;
    };
    /**
     * @param {?} item
    ...
    function (item) {
        ...
        this.selectedItems.forEach(function (selectedItem, itemIndex) {
            if (_this.selectComponent._getItemValue(item) ===
                _this.selectComponent._getStoredItemValue(selectedItem)) {
    ...
    function () {
        ...
        if (this.selectComponent._hasSearch()) {
            ...
            if (!this.selectComponent._filterText || !this.selectComponent._filterText.trim()) {
                groups_1 = this.selectComponent._groups;
            }
            else {
                var /** @type {?} */ filterText_1 = this.selectComponent._filterText.trim().toLowerCase();
                this.selectComponent._groups.forEach(function (group) {
...
var SelectSearchableComponent = (function () {
    function SelectSearchableComponent(_modalController, ionForm, _platform, ionItem, _iterableDiffers) {
     ...
     * @return {?}
     */
    SelectSearchableComponent.prototype._setValue = /**
     * @param {?} value
     * @return {?}
     */
    function (value) {
...
export { SelectSearchableModule, SelectSearchableGroupRightTemplateDirective, SelectSearchableGroupTemplateDirective, SelectSearchableItemRightTemplateDirective, SelectSearchableItemTemplateDirective, SelectSearchableMessageTemplateDirective, SelectSearchablePageComponent, SelectSearchablePlaceholderTemplateDirective, SelectSearchableTitleTemplateDirective, SelectSearchableValueTemplateDirective, SelectSearchableComponent };
